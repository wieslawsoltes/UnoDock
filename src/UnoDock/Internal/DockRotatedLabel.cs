...
internal sealed class DockRotatedLabel : Panel
{
    ...
    private readonly CompositeTransform _rotation = new()
    {
        Rotation = 90
    };
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        child.Measure(_vertical ? new(availableSize.Height, availableSize.Width) : availableSize);
    ...
    protected override Size ArrangeOverride(Size finalSize)
    {
        ...
        if (_vertical)
        {
            ...
            if (!ReferenceEquals(child.RenderTransform, _rotation))
                child.RenderTransform = _rotation;
        }
        else
        {

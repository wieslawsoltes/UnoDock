...
public class LayoutDocumentPaneControl : LayoutCachePaneControl, ILayoutControl, IRefreshableLayoutControl
{
    ...
    public LayoutDocumentPaneControl(LayoutDocumentPane model)
    {
    ...
    void IRefreshableLayoutControl.Update(DockSurface surface)
    {
        Style = surface.Manager.DocumentPaneControlStyle;
        UpdatePane(_model, surface);
    }

...
{
    public static readonly DependencyProperty DockingGuideModeProperty = DependencyProperty.Register(nameof(DockingGuideMode), typeof(DockingGuideMode), typeof(DockingManager), new PropertyMetadata(DockingGuideMode.GuidesOnly, OnDockingGuideModeChanged));
    ...
    public DockingGuideMode DockingGuideMode
    {
        ...
        set
        {
            ...
            SetValue(DockingGuideModeProperty, value);
        }
    }
    ...
    public bool ShowDocumentPaneToolGuides { get => (bool)GetValue(ShowDocumentPaneToolGuidesProperty); set => SetValue(ShowDocumentPaneToolGuidesProperty, value); }
    ...
    public IReadOnlyList<DockGuideTarget> GetDockingGuides(LayoutContent content, Point surfacePoint)
    {
        ...
        if (!double.IsFinite(surfacePoint.X) || !double.IsFinite(surfacePoint.Y))
            throw new ArgumentOutOfRangeException(nameof(surfacePoint));

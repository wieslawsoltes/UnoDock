...
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => ConverterInterop.Side(value)is AnchorSide.Left or AnchorSide.Right ? Orientation.Vertical : Orientation.Horizontal;

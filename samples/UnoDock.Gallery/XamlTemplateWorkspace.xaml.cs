...
public sealed partial class XamlTemplateWorkspace : UserControl, IDisposable
{
    ...
    public void TogglePalette() => Dock.Theme = Dock.Theme is Themes.ResourceDictionaryTheme ? new Themes.FluentTheme
    {
        Density = Themes.DockDensity.Comfortable
    }

    : (Themes.ResourceDictionaryTheme)Resources["OceanDockTheme"];

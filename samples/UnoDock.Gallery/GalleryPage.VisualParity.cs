...
public sealed partial class GalleryPage
{
    private void ShowVisualParityLab()
    {
        ...
        {
            manager.Theme = null;
            manager.RequestedTheme = ElementTheme.Light;
        });
        Add("Dark", () =>
        {
            manager.Theme = null;
            manager.RequestedTheme = ElementTheme.Dark;
        });
        ...
        Add("Reset", () =>
        {
            manager.Resources.Remove("UnoDock.TabHeight");
            VisualScene.Populate(manager);
            manager.Refresh();
        });
        ...
        {
            Title = "Visual parity",
            ContentId = "visual-parity:" + Guid.NewGuid().ToString("N"),
            Content = panel
        };

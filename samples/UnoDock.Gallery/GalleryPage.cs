...
public sealed partial class GalleryPage : Page
{
    ...
    public GalleryPage()
    {
        ...
        var build = new TextBlock { Text = "UNO 6.7  /  INDEPENDENT IMPLEMENTATION  /  PREVIEW 4", VerticalAlignment = VerticalAlignment.Center, FontSize = 11, Opacity = .65 }; Grid.SetColumn(build, 1); brand.Children.Add(build); shell.Children.Add(brand);
        ...
        Add("Reset", Reset); Add("1,000 tabs", Stress); Add("Parity lab", ShowParityLab); Add("Converter lab", ShowConverterLab); Add("Native windows", ShowNativeWindowLab); Add("Window shell", ShowShellLab);
